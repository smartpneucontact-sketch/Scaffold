...
from case_pilot.rag.store import Chunk, RetrievedChunk
...
class Retriever:
    """In-memory BM25 retriever. Shape is a low-code-friendly interface —
    in a Power Platform deployment this would be a SharePoint Search call or
    an Azure AI Search index behind a custom connector."""
